          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-black tracking-tight flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-emerald-500 text-white text-[10px] font-bold">معايير DrugBank 🌐</span>
              </h3>
              <p className="text-xs text-emerald-200 font-medium">حركيات الدواء، استقلاب CYP450، التداخلات المعتمدة، وتحذيرات الصرف السريري</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          {sendResult ? (
            ...
            <div className="p-8 rounded-3xl bg-emerald-50 border border-emerald-200 text-center space-y-4 max-w-lg mx-auto">
              ...
              <p className="text-xs text-emerald-800 font-medium">
                تم تثقيف الفريق عن الصنف: <b>{selectedProduct?.name}</b> وفق معايير DrugBank السريرية
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-7 space-y-4">
                {/* Editor with DrugBank Direct Link */}
                <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-2.5">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <label className="text-xs font-black text-slate-900 flex items-center gap-1.5">
                      <Sparkles className="w-4 h-4 text-emerald-600" />
                      <span>3. المحتوى السريري المولد بمعايير DrugBank:</span>
                    </label>
                    ...
                    {capsuleData?.drugBankUrl && (
                      ...
                      >
                        ...
                        <span>🔗 مرجع DrugBank السريري</span>
